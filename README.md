...
Standalone lecture-plugin repo for **`grade-7.physics.si-units`**, deployed to the ed-tech
...
```
https://cdn.jsdelivr.net/gh/<owner>/plugin-grade-7-physics-si-units@v<version>/dist/index.js
```
