...
function Confetti({ pieces = 28 }: ConfettiProps) {
  return (
    <div className="pl-g7-physics-si-units-confetti" aria-hidden="true">
      {Array.from({ length: pieces }).map((_, i) => {
        ...
        return (
          <span key={i} className="pl-g7-physics-si-units-confetti-piece" style={style} />
        );
      })}
    </div>
  );
...
function SlideView({
  ...
  return (
    ...
    >
      {emoji ? (
        <span className="pl-g7-physics-si-units-emoji" aria-hidden="true">
          {emoji}
        </span>
      ) : null}

      <h3 className="pl-g7-physics-si-units-prompt">{prompt}</h3>

      <div className="pl-g7-physics-si-units-options" data-layout={optionsLayout(choices)}>
      ...
      <p className="pl-g7-physics-si-units-sr-only" aria-live="polite">
        {feedback}
      </p>

      <p className="pl-g7-physics-si-units-step">
...
export default function QuizApp({ context }: Props) {
  ...
  if (completed) {
    return (
      <div className="pl-g7-physics-si-units-root">
        <div className="pl-g7-physics-si-units-complete">
          <div className="pl-g7-physics-si-units-parade" aria-hidden="true">
          ...
          <h2 className="pl-g7-physics-si-units-complete-title">{t('completeTitle')}</h2>
          <p className="pl-g7-physics-si-units-complete-body">
  ...
  return (
    <div className="pl-g7-physics-si-units-root">
      ...
      <div className="pl-g7-physics-si-units-trail" aria-hidden="true">
        {questions.map((question, i) => (
          <span
            key={i}
            className={cx(
      ...
      <div className="pl-g7-physics-si-units-stage">
        <SlideView
          key={safeIndex}
